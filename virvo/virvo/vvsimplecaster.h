...
class vvSimpleCaster : public vvRenderer
{
public:
    VVAPI vvSimpleCaster(vvVolDesc* vd, vvRenderState renderState);
    VVAPI ~vvSimpleCaster();
...
private:
    ...
    VV_NOT_COPYABLE(vvSimpleCaster)

};


#endif // VV_SIMPLECASTER_H
